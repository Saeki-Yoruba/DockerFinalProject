...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "後台商店資訊回應 DTO")
public class StoreAdminResponseDto {
    ...
    @Schema(description = "每多少消費金額換 1 點", example = "100")
    private Double pointsPerCurrency;

    @Schema(description = "每點數折抵金額", example = "1.0")
    private Double currencyPerPoint;

    @Schema(description = "是否啟用商店", example = "true")
