...
public class StoreUpdateDto {
    ...
    @Schema(description = "商店 Layout 圖片 URL", example = "/images/layout.png")
    private String layoutUrl;

    @Schema(description = "歡迎訊息", example = "歡迎光臨丸竹儀，祝您用餐愉快")
    private String welcomeMessage;

    @Schema(description = "每多少消費金額換 1 點 (例: 100 = 消費 100 元得 1 點)", example = "100")
    private Integer pointsPerCurrency;

    @Schema(description = "每點數折抵金額 (例: 1 = 1 元)", example = "1.0")
    private Double currencyPerPoint;

    @Schema(description = "是否啟用商店 (ADMIN 可改)", example = "true")
